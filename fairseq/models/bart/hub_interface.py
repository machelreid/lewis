...
class BARTHubInterface(GeneratorHubInterface):
    ...
    def encode(
        ...
        # if isinstance(self.task, TranslationFromXBARTTask):
        bpe_sentence = (
            bpe_sentence.replace("1279 27932 29", "<mask>")
            .replace("27 27932 29", "<mask>")
            .replace("7359 82 29", "</s>")
        )
        ...
        **generate_kwargs
        ...
        for masked_input in masked_inputs:
            ...
            text_spans_bpe = (
                ...
                .join(
                    [
                        self.bpe.encode(text_span.rstrip().replace("</s>", " </s>"))

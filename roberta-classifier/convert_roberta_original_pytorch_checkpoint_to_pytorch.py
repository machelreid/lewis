...
def convert_roberta_checkpoint_to_pytorch(
    ...
    roberta = FairseqRobertaModel.from_pretrained(
        ...
        "checkpoint_best.pt",
        data_name_or_path=roberta_checkpoint_path + "/../data-bin",
    )
    ...
    # for older fairseq versions use this
    # model.roberta.embeddings.LayerNorm.weight = roberta_sent_encoder.emb_layer_norm.weight

    # for newer versions the paremeter was renamed
    # https://github.com/pytorch/fairseq/blob/425c36eafff535fe7337f8bdd5ace22ebacc78cb/fairseq/models/roberta/model.py#L289
    model.roberta.embeddings.LayerNorm.weight = (
        roberta_sent_encoder.layernorm_embedding.weight
    )

    model.roberta.embeddings.LayerNorm.bias = (
        roberta_sent_encoder.layernorm_embedding.bias
    )
